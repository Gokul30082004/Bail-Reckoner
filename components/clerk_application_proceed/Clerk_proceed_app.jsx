...
export const Clerk_proceed_app = () => {
  return (
            ...
            <div className='assign-ticket'>
                <center>
                    ...
                    <div className='leave-form' id='leave-form'>
                        ...
                        <button type='submit'name='submit' className='apply-leave-btn'>Proceed</button>
                        <button type='submit'name='submit' className='apply-leave-btn'>Return</button>
                    </div>
                </center>
            </div>
        </div>
